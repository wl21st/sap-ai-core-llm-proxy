#!/usr/bin/env python3
"""
Test script for the YYYYMMDD_hhmmss timestamped hierarchical logging structure.
"""

from saip.utils.logging_utils import get_server_logger, get_transport_logger, get_token_usage_logger
import logging
import os

def test_yyyymmdd_logging():
    """Test the YYYYMMDD_hhmmss timestamped hierarchical logging structure."""
    print("Testing YYYYMMDD_hhmmss timestamped hierarchical logging structure...")
    ...
    print("\nCurrent log files (should use YYYYMMDD_hhmmss format):")
    ...
    print("Example: server_20241224_225808.log")

if __name__ == "__main__":
    test_yyyymmdd_logging()
