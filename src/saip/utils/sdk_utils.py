...
def extract_deployment_id(deployment_url: str) -> str:
    ...
    if not deployment_url or not isinstance(deployment_url, str):
        from saip.utils.exceptions import DeploymentResolutionError
...
def clear_deployment_cache() -> bool:
    ...
    """
    from saip.utils.cache_utils import clear_deployment_cache as _clear_deployment_cache
...
def get_cache_stats() -> dict:
    ...
    """
    from saip.utils.cache_utils import get_cache_stats as _get_cache_stats
...
def fetch_all_deployments(
    ...
    from saip.utils.error_ids import ErrorIDs
    from saip.utils.exceptions import CacheError, DeploymentFetchError
    ...
    try:
        with Cache(CACHE_DIR) as cache:
            ...
            if not force_refresh:
                ...
                if cached_data:
                    from saip.utils.cache_utils import format_cache_expiry
