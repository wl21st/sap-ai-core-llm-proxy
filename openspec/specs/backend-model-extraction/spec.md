# backend-model-extraction Specification

## Purpose
Enable extraction of backend model names from SAP AI Core deployment responses to support dynamic model discovery and aliasing.
