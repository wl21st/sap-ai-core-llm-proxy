# Capability: TLS CA Certificate Fallback

## Purpose

Ensure the proxy can resolve a usable CA certificate bundle even when the environment default is missing or inaccessible.
...
### Requirement: Validate configured certificate paths at startup
