...
## Purpose
Define the FastAPI router-based API endpoints that replace the existing Flask Blueprint structure, providing standardized request handling and response formats.
