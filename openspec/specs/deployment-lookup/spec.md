...
Enable users to configure deployment IDs in the proxy configuration and automatically resolve the corresponding Deployment URLs using the SAP AI Core SDK at startup, while maintaining backward compatibility with existing URL-based configurations.
