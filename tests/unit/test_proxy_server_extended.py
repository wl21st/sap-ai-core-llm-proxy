...
def setup_test_config():
    ...
    if proxy_server.proxy_config is None:
        from saip.config import ProxyConfig
...
class TestEmbeddingEndpoint:
    ...
    @patch("saip.routers.embeddings.load_balance_url")
    @patch("saip.proxy_server.handle_embedding_service_call")
...
class TestConvertersEdgeCases:
    ...
    def test_convert_gemini_to_openai_with_usage(self):
        ...
        from saip.proxy_helpers import Converters
...
class TestParseArguments:
    ...
    def test_parse_arguments_default(self):
        ...
        from saip.proxy_server import parse_arguments
...
class TestProxyOpenAIStreamEndpoint:
    ...
    @patch("saip.auth.request_validator.RequestValidator.validate")
    @patch("saip.proxy_server.TokenManager")
